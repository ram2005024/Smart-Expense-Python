    ...
    <div className="w-full min-h-screen flex flex-col">
        ...
        <nav class="h-17.5 relative w-full px-6 md:px-16 overflow-y-clip lg:px-24 xl:px-32 flex items-center border-b border-b-gray-200 bg-gray-50  justify-between z-20  text-gray-700 shadow-[0px_4px_25px_0px_#0000000D] transition-all">
          ...
          {user ? (
            <button
              ...
              type="button"
              class="bg-red-500 max-md:hidden text-white border border-gray-300  text-sm hover:bg-red-700 cursor-pointer active:scale-95 transition-all p-2 px-4 rounded-md"
            >
              Logout
            </button>
          ) : (
            <button
              ...
              type="button"
              class="bg-emerald-500 max-md:hidden text-white border border-gray-300  text-sm hover:bg-emerald-600 active:scale-95 transition-all  p-2 px-4 rounded-md"
            >
              Login
            </button>
          )}
      ...
      <footer className="flex flex-col items-center justify-around w-full h-fit py-6 text-sm   text-gray-800/70 border-t border-gray-100">
        ...
        <p className="mt-4 text-center">
          Copyright © 2026 <a href="https://prebuiltui.com">Smart Expense</a>.
