            ...
            <div className="w-full">
              <div className="w-full sticky top-0  z-40  rounded-t-lg py-4 px-2 bg-indigo-600 text-white font-semibold">
                <div className="flex w-full justify-between">
                  ...
                  <div
                    onClick={() => setIsAddExpense(false)}
                    className="w-12 h-12 flex items-center justify-center transtion-all duration-150 ease-in cursor-pointer hover:bg-gray-100/20 rounded-md group"
                  >
            ...
            <div className="flex-1 ">
              <div className="w-full h-full overflow-y-scroll  space-y-3.5 ">
                <div className="flex flex-col gap-2 w-11/12 mx-auto ">
                  ...
                  >
                    Expense Name{" "}
                    <span className="transform rotate-45 text-red-600"> *</span>
                  </label>
                  <input
                    ...
                    {status.map((i, idx) => {
                      ...
                      return (
                        <div
                          key={idx}
                          onClick={() => {
                            handleChange("status", i.value);
                            setActiveStatus(i.name);
                          }}
                          className={`
                ...
                <div className="w-full flex flex-col gap-2 px-3.5 mb-4">
                  ...
                  {previewURL ? (
                    ...
                    <label
                      htmlFor="_image_receipt"
                      className="w-full h-20 border border-gray-400 border-dashed flex items-center
              ...
              <div className=" flex gap-2 text-sm font-semibold">
                <button
                  ...
                  className="
                                    ...
                                    p-2 my-2 px-4 rounded-lg text-gray-500 bg-slate-200 cursor-pointer"
                >
                  Cancel
                </button>
                ...
                {!loading ? (
                  <button
                    ...
                    className="group my-2 px-4 p-2 rounded-lg disabled:cursor-not-allowed disabled:bg-slate-200 disabled:text-gray-500 bg-green-500 text-white inline-flex items-center  "
                  >
