...
const Home = () => {
  return (
    <section id="section" class=" h-full w-full">
      <main class="flex flex-col md:flex-row items-center max-md:text-center justify-between  pb-16 px-6 h-full sm:px-10 md:px-24 max-w-7xl mx-auto w-full">
        <div class="flex flex-col items-center md:items-start ">
          <button
            ...
            type="button"
          >
            <span>Track your expense wisely.</span>
          ...
          <h1 class="text-gray-900 font-semibold text-3xl sm:text-4xl md:text-5xl max-w-xl overflow-y-hidden">
            ...
            <span class="text-indigo-600"> tracking expense</span>
          </h1>
        ...
        <div
          ...
          class="mt-12 grid grid-cols-2 gap-6 pb-6"
        >
          <img
            alt=""
            class="size-32 rounded-lg hover:scale-105 transition duration-300  shadow-lg object-fill  "
            src={heroIcons.hero1}
          />
          <img
            alt=""
