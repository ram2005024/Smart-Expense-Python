...
class Budget(models.Model):
    ...
    def active_budget(self):
        ...
        total_spent=self.budget_expenses.aggregate(
...
class Expense(models.Model):
    ...
    status=models.CharField(max_length=50,choices=expense_status,null=False,blank=False)
    ...
    #    Check if the remaining budget amount is valid or not
       ...
       if (total_spent >= self.budget.budget_amount) or (self.budget.valid_until and datetime.date.today()>self.budget.valid_until):
