...
urlpatterns = [
    ...
    path("expense/summarize_spend_categories",views.get_spend_by_categories,name="get_spend_by_categories"),
    path("expense/get_category_budget_usage",views.get_category_budget_usage,name="get_category_budget_usage"),
    ...
    path('ai/expense/total_spent',views.get_total_spend_insight,name="total-spend-insight"),
    path('ai/expense/reimbrushed',views.analyse_reimbrushed,name="reimbrushed-insight"),
